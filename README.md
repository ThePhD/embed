...
Available on Compiler Explorer ([LINK: e.g. 1](https://godbolt.org/z/nEdKjK)), courtesy of the help of the blessed Matt Godbolt and Patrick Quist.
...
- [x] Clang Progress:
  ...
  - [ ] `#embed` inside braced _initializer-list_ (produces erroneous code generation for temporaries for `std::initializer_list`)
  - [ ] None of the above works in C standard (`-std=c2x`) mode
